    ...
    <div className="min-h-screen bg-background text-foreground relative">
      ...
      <nav className="fixed left-8 top-1/2 -translate-y-1/2 z-20 hidden lg:block">
        <div className="relative flex flex-col gap-4">
          ...
          <div className="absolute left-1/2 -translate-x-1/2 top-0 bottom-0 w-[3px] bg-muted-foreground/20 rounded-full" />
          {/* Progress fill */}
          <div
            className="absolute left-1/2 -translate-x-1/2 top-0 w-[3px] bg-foreground rounded-full transition-all duration-300"
      ...
      <main className="max-w-4xl mx-auto px-6 sm:px-8 lg:px-16">
          ...
          <div className="space-y-16">
            ...
            <div className="space-y-12">
              {[
                ...
                <div
                  key={index}
                  className="group grid lg:grid-cols-12 gap-8 py-6 border-b border-border/50 hover:border-border transition-colors"
                >
                  <div className="lg:col-span-2 text-xl sm:text-2xl font-light text-muted-foreground group-hover:text-foreground">
                    {job.year}
                  </div>
        ...
        <section
          ...
          className="pt-16 pb-0 sm:pt-20 sm:pb-0 opacity-0"
        >
          <h2 className="text-3xl sm:text-4xl font-light mb-2">Kits</h2>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-4">
            {[
              ...
              >
                <div className="w-14 h-14 flex items-center justify-center border border-border rounded-lg hover:border-muted-foreground/50 transition">
                  {kit.type === "image" ? (
                    <img src={kit.src} alt={kit.name} width="32" height="32" />
                  ) : (
                    mounted &&
                    kit.icon && (
                      <kit.icon
        ...
        <footer className="py-12 sm:py-16 border-t border-border">
          <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-6">
            ...
            <div className="flex items-center gap-4">
              ...
              >
                {!mounted ? (
                  // Render nothing or a neutral placeholder until mounted
