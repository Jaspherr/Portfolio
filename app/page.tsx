            ...
            <div className="lg:col-span-3 space-y-6 sm:space-y-8">
              <div className="space-y-3 sm:space-y-2">
                ...
                <h1 className="text-5xl sm:text-6xl lg:text-7xl font-light tracking-tight">
                  Jaspher
                  <br />
                  <span className="text-muted-foreground">Tania</span>
                </h1>
              </div>
              ...
              {[
                {
                  year: "2025",
                  role: "Sakay",
                  company: "4th Year Capstone Project",
                  description:
                    "App that tracks buses in real-time, showing locations and ETAs. It helps drivers optimize routes and reduces waiting times for passengers.",
                ...
                },
                {
                  ...
                  description:
                    "Developed a school essentials app for UPang students to streamline the distribution process. Designed a modern, user-friendly interface to enhance accessibility and usability.",
                  tech: ["Ruby", "React", "PostgreSQL"],
                },
                {
                  year: "2023",
                  role: "Kithara",
                  company: "1st Year Project",
                  description:
                    "Built a free website for guitar enthusiasts, managing design, content, and brand identity. Enhanced the platform’s structure and performance to deliver a better learning experience.",
...
>
  {/* Kits */}
  <h2 className="section-title text-3xl sm:text-4xl font-light mb-12">
    Kits
  </h2>

  <section className="icons-grid grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-8">
    {[
      ...
      <div
        key={kit.name}
        className="icon-card flex flex-col items-center text-center space-y-2"
      >
        <div className="icon-placeholder w-16 h-16 flex items-center justify-center border border-border rounded-lg hover:border-muted-foreground/50 transition-all duration-300">
          {kit.type === "image" ? (
            <img
              src={kit.src}
              alt={kit.name}
        ...
        <div className="icon-label text-sm text-muted-foreground">
          {kit.name}
        </div>
      </div>
    ))}
